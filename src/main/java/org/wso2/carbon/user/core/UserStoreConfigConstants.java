...
public class UserStoreConfigConstants {
    ...
    public static final String CaseInsensitiveUsername = "CaseInsensitiveUsername";
    public static final String CaseInsensitiveUsernameDescription = "Is the username case insensitive username or not?";
