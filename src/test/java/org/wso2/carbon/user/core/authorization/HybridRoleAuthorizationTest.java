...
public class HybridRoleAuthorizationTest extends BaseTestCase {
    ...
    public void testAuthorizationForActions() throws Exception {
        ...
        assertTrue(treeNode.isRoleAuthorized(roleName, PermissionTreeUtil.actionToPermission(actionConsume)));
        assertNull(treeNode.isRoleAuthorized(roleName, PermissionTreeUtil.actionToPermission(actionUIExecute)));
    }
    ...
    public void testLowerCaseDomainName() throws Exception {
        ...
        assertTrue(
                treeNode.isRoleAuthorized(modifiedRoleName, PermissionTreeUtil.actionToPermission(actionConsume)));
    ...
    public void testUpperCaseDomainName() throws Exception {
       ...
       assertTrue(treeNode.isRoleAuthorized(modifiedRoleName, PermissionTreeUtil
                .actionToPermission(actionConsume)));
    }
    ...
    public void testLowerCaseRoleName() throws Exception {
        ...
        assertNull(treeNode.isRoleAuthorized(roleName.toLowerCase(), PermissionTreeUtil
                .actionToPermission(actionConsume)));
    }
    ...
    public void testUpperCaseRoleName() throws Exception {
        ...
        assertNull(treeNode.isRoleAuthorized(roleName.toUpperCase(), PermissionTreeUtil
                .actionToPermission(actionConsume)));
    }
